...
docker-compose -f docker-compose.yml up -d ca.org1.example.com ca.org2.example.com  ca.org3.example.com  ca.org4.example.com orderer.example.com peer0.org1.example.com peer1.org1.example.com peer2.org1.example.com couchdb1 peer0.org2.example.com peer1.org2.example.com couchdb2 peer0.org3.example.com peer1.org3.example.com couchdb3 peer0.org4.example.com peer1.org4.example.com couchdb4
